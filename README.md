...
Copyright Alex Peyrard.  
All rights reserved for the content data under `_posts`, `_portfolio` and `img`, the rest of the code is released under the [MIT](https://github.com/ShikherVerma/shikherverma.github.io/blob/gh-pages/LICENSE) license.
